...
static bool getFileTimeFromProperty(IInArchive* archive, int index, int propId, FILETIME *ft)
{
    ...
    if (prop.vt != VT_FILETIME) {
        qDebug()<<QCoreApplication::translate("Q7z",
...
QVector<File> listArchive(QFile *archive)
{
...
*/
void Q7Z_EXPORT createArchive(QFile *archive, const QStringList &sources,
...
*/
void extractArchive(QFile *archive, const QString &directory, ExtractCallback *callback)
{
    Q7Z_ASSERTS(archive, Readable)
...
/*!
    ...
    \note Throws SevenZipException on error.
*/
bool isSupportedArchive(QFile *archive)
{
    Q7Z_ASSERTS(archive, Readable)
