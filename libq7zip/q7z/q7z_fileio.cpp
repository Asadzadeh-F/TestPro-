...
qint64 Q7z::retrieveInt64(QFile *in)
{
    qint64 n = 0;
...
void Q7z::appendInt64(QFile *out, qint64 n)
{
    Q7z::blockingWrite(out, reinterpret_cast<const char*>(&n), sizeof(n));
}

Range<qint64> Q7z::retrieveInt64Range(QFile *in)
{
...
void Q7z::appendInt64Range(QFile *out, const Range<qint64> &r)
{
    Q7z::appendInt64(out, r.start());
    Q7z::appendInt64(out, r.length());
}

QString Q7z::retrieveString(QFile *in)
{
    return QString::fromUtf8(Q7z::retrieveByteArray(in));
}

void Q7z::appendString(QFile *out, const QString &str)
{
    Q7z::appendByteArray(out, str.toUtf8());
}

QByteArray Q7z::retrieveByteArray(QFile *in)
{
...
void Q7z::appendByteArray(QFile *out, const QByteArray &ba)
{
    Q7z::appendInt64(out, ba.size());
    Q7z::blockingWrite(out, ba.constData(), ba.size());
}

QByteArray Q7z::retrieveData(QFile *in, qint64 size)
{
...
void Q7z::appendData(QFile *out, QFile *in, qint64 size)
{
    Q_ASSERT(!in->isSequential());
    Q7z::blockingCopy(in, out, size);
}

void Q7z::openForRead(QFile *dev)
{
    Q_ASSERT(dev);
...
void Q7z::openForWrite(QFile *dev)
{
    Q_ASSERT(dev);
...
void Q7z::openForAppend(QFile *dev)
{
    Q_ASSERT(dev);
...
qint64 Q7z::blockingRead(QFile *in, char *buffer, qint64 size)
{
    if (in->atEnd())
        return 0;
    qint64 left = size;
...
qint64 Q7z::blockingCopy(QFile *in, QFile *out, qint64 size)
{
...
qint64 Q7z::blockingWrite(QFile *out, const QByteArray &data)
{
    return Q7z::blockingWrite(out, data.constData(), data.size());
}

qint64 Q7z::blockingWrite(QFile *out, const char *data, qint64 size)
{
    qint64 left = size;
    while (left > 0) {
